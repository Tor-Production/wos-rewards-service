/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging ./worker-configuration.d.ts` (hash: 2e2dcd5460f7ee4007641252181e4596)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 
interface __BaseEnv_Env {
	STAGING_DB: D1Database;
	REGISTRATION_JOBS_QUEUE: Queue;
	CODE_FANOUT_JOBS_QUEUE: Queue;
	ENVIRONMENT: "staging";
	PROVIDER_MODE: "mock";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PROVIDER_MODE" | "PRODUCTION_REDEMPTION_ENABLED" | "CODE_DISCOVERY_ENABLED" | "LOG_LEVEL" | "DISCORD_GUILD_ID" | "DISCORD_REGISTRATION_CHANNEL_ID" | "DISCORD_MVP_ADMIN_CHANNEL_ID" | "DISCORD_MVP_ADMIN_USER_ALLOWLIST" | "DISCORD_APPLICATION_ID" | "DEFAULT_STATE" | "SPIKE_SENDER_ALLOWLIST" | "DISCORD_MESSAGE_MAX_LENGTH" | "OPERATION_DEADLINE_SECONDS" | "REDEMPTION_MAX_REEVAL" | "OUTBOX_DISPATCH_MAX_ATTEMPTS" | "PROVIDER_MAX_INVOCATIONS" | "PROVIDER_MAX_RETRIES" | "ITEM_CLAIM_LEASE_SECONDS" | "REDEMPTION_CLAIM_LEASE_SECONDS" | "PROVIDER_TIMEOUT_SECONDS" | "OUTPUT_CLAIM_LEASE_SECONDS" | "OUTPUT_TIMEOUT_SECONDS" | "OUTPUT_DISPATCH_MAX_ATTEMPTS" | "SUMMARY_MAX_CHUNKS" | "DISCORD_DELIVERY_ENABLED" | "REDEMPTION_AUTO_REOPEN_RETRY_EXHAUSTED" | "INGESTION_SHARED_SECRET" | "DISCORD_BOT_TOKEN">> {}
}
